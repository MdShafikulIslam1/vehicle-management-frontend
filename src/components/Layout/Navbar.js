...
if (typeof window !== 'undefined') {
  ...
  return (
    ...
    >
      ...
      <a href="#" target="_blank" className="border-2 border-brand py-2 px-5 text-white font-bold rounded-sm">VT-Shop</a>
      
      
        {/* Login & logout will be conditional rendering */}
        <Link href="/login" className="border-2 border-green-400 py-2 px-5 text-white font-bold rounded-sm">Log In</Link> 
